...
/** @jsx React.DOM */
define('view/mixin/SetStateSilent',[],function () {
  var SetStateSilent = {
    getInitialState: function () {
      return {
        entered: false
